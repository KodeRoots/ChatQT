...
QtObject {
    ...
    property bool ollamaDisableThinking: _settings.value("ollamaDisableThinking", false)
    ...
    function save() {
        ...
        _settings.setValue("ollamaDisableThinking", ollamaDisableThinking)
    ...
    onOllamaDisableThinkingChanged: save()
