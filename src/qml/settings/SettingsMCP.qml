...
Kirigami.ScrollablePage {
    ...
    ColumnLayout {
        ...
        QQC2.Label {
            text: i18nc("@info", "Configure MCP (Model Context Protocol) servers to give AI models access to external tools. Add servers like Exa, Firecrawl, or any MCP-compatible service.")
        ...
        Kirigami.Dialog {
            ...
            function openServer(index) {
                ...
                typeCombo.currentIndex = server.type === "remote" ? 0 : 0
            ...
            ColumnLayout {
                ...
                QQC2.TextField {
                    id: displayNameField
                    Layout.fillWidth: true
                    placeholderText: i18nc("@info:placeholder", "e.g., Exa Search, Firecrawl")
                }
                ...
                QQC2.Label {
                    text: i18nc("@info", "Example: {\"x-api-key\": \"your-key\"} for servers that require headers other than Bearer token.")
                    font: Kirigami.Theme.smallFont
                    color: Kirigami.Theme.disabledTextColor
                    wrapMode: Text.WordWrap
                    Layout.fillWidth: true
